			...
			<table id="unprintedIndexTable" style="width:100%;min-width:650px;" runat="server">
				<tr style="height:40px;background-color:#e6f3ff;padding-top:5px;">
					...
					<td style="padding:5px 8px 5px 5px;text-align:left;text-align:right;">
						<asp:Button ID="deleteBtn" style="padding:1px 6px 1px 6px;" Font-Size="10" runat="server" Text="Delete" 
							OnClientClick="return confirm('Selected Indexes will be permanently deleted. Delete anyway?');" 
							OnClick="deleteIndexes_Click" />
						<asp:Button ID="printBarcodeBtn" style="margin-left:10px;padding:1px 6px 1px 6px;" Font-Size="10" runat="server" Text="Print" onclick="printBarcode_Click"/>
                        <asp:Button ID="showPrinted" style="margin-left:10px;padding:1px 6px 1px 6px;" Font-Size="10" Visible="true" runat="server" Text="Show Printed" onclick="showPrinted_Click"/>
