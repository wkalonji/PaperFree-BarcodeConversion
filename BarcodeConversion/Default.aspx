...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<script>
		...
		function function2() {
		    // Are you satisfied?
		    document.getElementById("MainContent_pageToPrint").style.display = "none";
	...
	<div ID="formPanel" runat="server">
		...
		<asp:UpdatePanel ID="formPanelJobSelection" runat="server">
            <ContentTemplate>
		...
		<asp:UpdatePanel ID="indexCreationUpdatePanel" runat="server" >
            <Triggers>
